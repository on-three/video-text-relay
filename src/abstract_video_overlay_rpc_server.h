...
class Abstract_video_overlay_rpc_Server : public jsonrpc::AbstractServer<Abstract_video_overlay_rpc_Server>
{
    public:
        ...
        {
            this->bindAndAddMethod(new jsonrpc::Procedure("add_msg", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_STRING, "font",jsonrpc::JSON_STRING,"friendly_name",jsonrpc::JSON_STRING,"msg",jsonrpc::JSON_STRING,"x",jsonrpc::JSON_INTEGER,"y",jsonrpc::JSON_INTEGER, NULL), &Abstract_video_overlay_rpc_Server::add_msgI);
        ...
        {
            response = this->add_msg(request["font"].asString(), request["friendly_name"].asString(), request["msg"].asString(), request["x"].asInt(), request["y"].asInt());
        }
        ...
        virtual std::string add_msg(const std::string& font, const std::string& friendly_name, const std::string& msg, const int& x, const int& y) = 0;
